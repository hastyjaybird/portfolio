# IOGS (Industrial Off-Grid Systems)

| Field | Value |
|---|---|
| Organization | IOGS — ISO/virtual-IPP model for the Guardiola Real Estate (GRE) portfolio |
| Role/title | Founder / Team Lead |
| Dates | 2019–2020 |
| Location | Puerto Rico |
| One-line summary | Led microgrid design/engineering and project finance for a 51-building, 5M sq ft Puerto Rico industrial park — reached "shovel ready," not built. |

## Key facts (verified)

- **No longer needs to be anonymous, per Jay (2026-06-30).** The Guardiola Real Estate (GRE) name and the IOGS project itself can now be used in materials. The one narrower rule still in force: don't name specific tenant industries (this was originally about not referencing a cannabis-related tenant — that specific detail still shouldn't appear, but the project/company identity itself is no longer restricted).
- Backed by Remedy Ventures PR Fund I (Matt Wiggins), targeting the Guardiola Real Estate (GRE) portfolio — **51 buildings, ~5,000,000 sq ft**, representing 74% of all industrial real estate in Puerto Rico. RFP goal date June 1, 2019.
- **Guardiola Real Estate independently confirmed online (2026-06-30):** principal Carlos Guardiola manages ~2,000,000 sq ft of industrial warehouse space in Puerto Rico (public figure, likely an earlier snapshot than the 5M sq ft combined-portfolio figure from Jay's internal docs, consistent with the portfolio having grown via the Goldman Sachs/CPG acquisition), overseeing 50+ multinational tenants, including a 62,000 sq ft lease to IKEA for its Caribbean Distribution Center. Sources: [Carlos Guardiola LinkedIn](https://www.linkedin.com/in/carlos-guardiola-b1b2189/), [CPG Warehouse Portfolio](http://www.cpgrealestate.com/comm_cpg_warehouse_port.php).
- Contemplated battery storage: **25.2 MW / 75.6 MWh** (3-day critical-load autonomy sizing, excluding the 2 largest tenants).
- Jay personally built the project timeline and financial model, including the **Qualified Opportunity Zone (QOZ) tax compliance structure** that let the renewable energy infrastructure serve as a tax write-off for the partners.
- Managed RFP process and EPC/architect/structural-engineer coordination (Luis Cid, Gabriel Rivera/Verdifica) and PREPA utility account transitions for tenants.
- An earlier CV listed this project as "25 buildings" — that figure is **superseded** by the Drive planning docs (51 buildings); confirmed by Jay to use 51 going forward.
...
- [x] `content/master-profile.md` (case study #3, IOGS half)
- [x] `content/experience-database.md`
- [x] `products/resume/sections/experience.tex`

## Still needed

- Download "IOGS Master Planning Doc & Onboarding" and "ALC Executive Summary and RFP Draft" from Drive into `pdfs/`
